...
class StudentAttendanceTileContainer extends StatelessWidget {
  const StudentAttendanceTileContainer({
    required this.isPresent, required this.student, required this.updateAttendance, required this.isOnLeave, super.key,
  });
            ...
            builder: (context, boxConstraints) {
              return Row(
                children: [
                  ...
                  SizedBox(width: boxConstraints.maxWidth * 0.045),
                  SizedBox(
                  ...
                  Column(
                    children: [
                      ...
                      SizedBox(height: boxConstraints.maxWidth * 0.018),
                    ],
                  ),
                ],
              );
